...
test.describe("Project Management", () => {
  ...
  test.describe("Project Creation", () => {
    ...
    test("should show project template selection", async ({ page }) => {
      ...
      await expect(
        page.locator("text=/Contract Analysis|Financial Reports|Legal Documents/i")
      ).toBeVisible();
  ...
  test.describe("Project Details and Management", () => {
    ...
    test("should add documents to project", async ({ page }) => {
      ...
      await fileInput.setInputFiles(["tests/fixtures/sample1.pdf", "tests/fixtures/sample2.pdf"]);
  ...
  test.describe("Project Analytics", () => {
    test("should view project analytics dashboard", async ({ page }) => {
      ...
      await expect(
        page.locator("text=/Total Documents|Processing Rate|Success Rate/i")
      ).toBeVisible();
    });
