...
function fillForm(name: string, email: string, password: string, confirmPassword: string) {
...
describe("RegisterForm", () => {
  ...
  describe("Zod Validation", () => {
    ...
    it("shows error for password without lowercase letter", async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText(/must contain at least one lowercase/i)).toBeInTheDocument();
      });
    });
