...
describe('DocumentUploadZone', () => {
  ...
  describe('Full Mode (default)', () => {
    it('renders drag-and-drop text', () => {
      ...
      expect(
        screen.getByText(/drag & drop documents here/i)
      ).toBeInTheDocument();
    });
    ...
    it('renders click-to-browse text', () => {
      render(<DocumentUploadZone {...defaultProps} />);
      expect(
        screen.getByText(/or click to browse your files/i)
      ).toBeInTheDocument();
    });
  ...
  describe('Compact Mode', () => {
    ...
    it('renders supported file types in compact mode', () => {
      render(<DocumentUploadZone {...defaultProps} compact />);
      expect(
        screen.getByText(/pdf, txt, md, csv, png, jpg/i)
      ).toBeInTheDocument();
    });
    ...
    it('does not render full-mode specific text in compact mode', () => {
      render(<DocumentUploadZone {...defaultProps} compact />);
      expect(
        screen.queryByText(/or click to browse your files/i)
  ...
  describe('File Selection', () => {
    ...
    it('renders without crashing when onFilesRejected is not provided', () => {
      expect(() => {
        render(
          <DocumentUploadZone onFilesAccepted={vi.fn()} />
        );
      }).not.toThrow();
    });
  });
  ...
  describe('Disabled State', () => {
    it('applies disabled styling', () => {
      const { container } = render(
        <DocumentUploadZone {...defaultProps} disabled />
      );
