...
export interface ConfidenceBarProps
  extends React.HTMLAttributes<HTMLDivElement>, VariantProps<typeof confidenceBarVariants> {
...
const ConfidenceBar = React.forwardRef<HTMLDivElement, ConfidenceBarProps>(
  ({ className, value, size, showLabel = false, labelPosition = "right", ...props }, ref) => {
...
export { ConfidenceBar, confidenceBarVariants, getConfidenceColor, getConfidenceTextColor };
