...
export const features = [
  ...
  },
  {
    ...
    description:
      'Organize documents into searchable knowledge bases with vector embeddings.',
  ...
  },
  {
    ...
    title: 'AI Assistants',
    description:
      'Build custom assistants with system prompts, KB binding, and embeddable widgets.',
