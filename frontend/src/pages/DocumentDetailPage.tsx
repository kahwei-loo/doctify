    ...
    return (
      <div className="flex flex-col items-center justify-center h-full p-8 text-center">
        ...
        <p className="text-muted-foreground mt-2 max-w-md">
          Your document is being analyzed and processed. This may take a few moments depending on
  ...
  if (status === "failed") {
    ...
    return (
      <div className="flex flex-col items-center justify-center h-full p-8 text-center">
        ...
        {errorMessage && <p className="text-destructive/80 mt-2 max-w-md">{errorMessage}</p>}
        {onRetry && (
  ...
  if (status === "cancelled") {
    return (
      <div className="flex flex-col items-center justify-center h-full p-8 text-center">
        ...
        <p className="text-muted-foreground mt-2 max-w-md">Document processing was cancelled.</p>
      </div>
    );
  }
...
const DocumentDetailPage: React.FC = () => {
  ...
  useEffect(() => {
    if (document && document.status === "completed") {
      console.log("📄 Document Loaded:", {
        ...
        metadataKeys: document.extraction_result?.metadata
          ? Object.keys(document.extraction_result.metadata)
          : [],
      });
    }
  }, [document]);
  ...
  const docType =
    document?.extraction_result?.metadata?.docType ||
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem onClick={() => copyToClipboard(document.document_id)}>
        ...
        <div className="h-full flex flex-col">
          {document.status === "completed" && document.extraction_result ? (
            <DocumentSplitView
              ...
              rightPanel={
                <ExtractedDataView result={document.extraction_result} document={document} />
              }
