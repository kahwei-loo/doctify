...
export const createAssistant = (data: {
  ...
  return new Promise((resolve) => {
    setTimeout(() => {
      ...
      console.log('[MockService] createAssistant: SUCCESS - resolving with:', newAssistant.assistant_id);
...
export const updateAssistant = (
  ...
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      ...
      console.log('[MockService] updateAssistant: SUCCESS - resolving with:', mockAssistants[index].assistant_id);
