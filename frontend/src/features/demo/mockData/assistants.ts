...
export const DEMO_ASSISTANTS = [
  {
    ...
    model_configuration: {
      model: 'gpt-4-turbo',
      temperature: 0.7,
      instructions: 'You are a document analysis assistant. Extract key information from documents including dates, amounts, parties, and terms. Provide structured output in JSON format.',
  ...
  },
  {
    ...
    model_configuration: {
      model: 'gpt-4-turbo',
      temperature: 0.5,
      instructions: 'You are a data extraction specialist. Focus on extracting invoice numbers, dates, line items, totals, and vendor information. Validate extracted amounts and dates.',
      tools: ['code_interpreter', 'function'],
    },
    widget_config: {},
    is_active: true,
    knowledge_base_id: null,
