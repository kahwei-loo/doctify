...
export const DEMO_QUERY_RESULTS = {
  ...
  "query-002": {
    success: true,
    answer:
      "Top 5 vendors by invoice amount: Acme Corp ($125,400), Tech Solutions ($98,750), Office Supplies Inc ($76,200), Legal Services LLC ($54,300), Marketing Agency ($42,100)",
    chart_data: {
      type: "pie",
      labels: [
        "Acme Corp",
  ...
  "query-004": {
    success: true,
    answer:
      "3 contracts expire in the next 60 days: ABC Corp Agreement (45 days), XYZ Services Contract (52 days), Vendor Partnership (58 days)",
    chart_data: null,
    sources: [
      {
        document_id: "doc-003",
