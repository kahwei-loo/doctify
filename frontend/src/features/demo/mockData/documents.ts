...
const DEMO_DOCUMENTS: MockDocument[] = [
  {
    ...
    extraction_result: {
      ...
      extracted_data: {
        ...
        currency: 'USD',
        line_items: [
          { itemNo: '1', description: 'Consulting Services', quantity: 40, unitPrice: 150.00, amount: 6000.00 },
          { itemNo: '2', description: 'Software License', quantity: 1, unitPrice: 500.00, amount: 500.00 },
        ],
      },
      confidence_scores: {
        invoice_number: 0.98,
  ...
  },
  {
    ...
    extraction_result: {
      ...
      extracted_data: {
        ...
        beginning_balance: 15420.00,
        ending_balance: 26565.00,
        total_deposits: 15000.00,
        total_withdrawals: 3855.00,
        transaction_count: 5,
        currency: 'USD',
      },
    },
  ...
  },
  {
    ...
    extraction_result: {
      ...
      extracted_data: {
        ...
        total_charges: 430.00,
        insurance_payment: 344.00,
        patient_responsibility: 86.00,
        currency: 'USD',
        line_items: [
          { itemNo: '1', description: 'Office Visit', quantity: 1, unitPrice: 250.00, amount: 250.00 },
          { itemNo: '2', description: 'Lab Tests', quantity: 1, unitPrice: 180.00, amount: 180.00 },
        ],
      },
    },
  },
...
const generateAdditionalDocuments = (): MockDocument[] => {
  ...
  const projectNames = ['Q1 2024 Invoices', 'Expense Receipts', 'Legal Contracts', 'Tax Documents 2023', undefined];
