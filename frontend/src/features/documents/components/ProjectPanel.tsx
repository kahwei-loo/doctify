            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  onClick={onToggleCollapse}
                >
                  <span className="text-xs font-medium">+{filteredProjects.length - 8}</span>
                </Button>
              </TooltipTrigger>
              <TooltipContent side="right">
                {filteredProjects.length - 8} more{" "}
                {filteredProjects.length - 8 === 1 ? "project" : "projects"}
              </TooltipContent>
            </Tooltip>
          )}
        </motion.div>
                ...
                <div className="flex items-center gap-2.5">
                  <div
                    className={cn(
                      ...
                      selectedProjectId === null ? "bg-primary/20" : "bg-muted"
                    )}
                  >
                    <FolderOpen
                      className={cn(
            ...
            <div className="px-2 pb-2 space-y-1">
              ...
              {!isLoading && !error && filteredProjects.length === 0 && (
                <div className="text-center py-8 px-4">
                  ...
                  {!searchQuery && (
                    <Button variant="link" size="sm" onClick={handleCreateProject} className="mt-2">
