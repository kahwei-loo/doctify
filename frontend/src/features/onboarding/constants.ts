...
export const ONBOARDING_STEPS: OnboardingStep[] = [
  {
    ...
    detail:
      "Supports multiple formats: PDF, PNG, JPG, and TIFF. Drag and drop or browse to upload.",
    icon: Upload,
    color: "text-blue-600",
  ...
  },
  {
    ...
    detail:
      "GPT-4V, Claude, and Gemini work together with automatic fallback for maximum accuracy.",
    icon: Sparkles,
  ...
  },
  {
    ...
    detail:
      "Vector embeddings with pgvector enable semantic search. Cohere reranking improves relevance.",
    icon: Database,
  ...
  },
  {
    ...
    detail:
      "Get answers grounded in your sources with citation links and groundedness verification.",
    icon: MessageSquare,
